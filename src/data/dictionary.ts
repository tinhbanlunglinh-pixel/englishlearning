...
export const commonWordsDictClient: Record<string, DictionaryEntry> = {
  ...
  "watermelon": { translation: "Dưa hấu", phonetic: "/ˈwɔːtəmelən/", sentence: "Watermelon is sweet and red inside.", sentenceTranslation: "Dưa hấu rất ngọt và có màu đỏ bên trong." },
  "strawberry": { translation: "Dâu tây", phonetic: "/ˈstrɔːbəri/", sentence: "I like sweet strawberry ice cream.", sentenceTranslation: "Tôi thích kem dâu tây ngọt ngào." },
  "mango": { translation: "Quả xoài", phonetic: "/ˈmæŋɡəʊ/", sentence: "The yellow mango is very tasty.", sentenceTranslation: "Quả xoài vàng rất là ngon." },
  "lime": { translation: "Chanh xanh", phonetic: "/laɪm/", sentence: "I put lime in my drink.", sentenceTranslation: "Tôi vắt chanh xanh vào đồ uống." },
