...
5. LEVEL-APPROPRIATE SENTENCES: The generated 'sentence' MUST perfectly match the complexity of the student's level (${level}). For Pre-starter/Starter: extremely simple 3-5 word sentences. For Movers: 5-7 word sentences. For Flyers: 7+ words with slightly more advanced grammar.`,
